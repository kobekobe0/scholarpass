...
const AddCedula = ({onClose}) => {
    ...
    const handleSubmit = async (e) => {
        try{
            ...
            const {data} = await axios.post(`${API_URL}cedula`, {
                bookletNumber,
                startOfCTC: startOfOR,
                preparedBy,
                dateFrom,
                dateTo,
            })
                ...
                <div className="inline-block align-bottom bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full">
                    <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                        ...
                        <div className="mt-4">
                            ...
                            <label className="text-md">CTC Number</label>
                            ...
                            <p className="text-sm text-gray-500 mb-4">Enter the first CTC number to record</p>
                            ...
                            <label className="text-md">Date From</label>
                            <input onChange={e=>setDateFrom(e.target.value)} value={dateFrom} type="date" className="p-2 border border-gray-600 rounded-md w-full mb-4"/>
                            
                            <label className="text-md">Date To</label>
                            <input onChange={e=>setDateTo(e.target.value)} value={dateTo} type="date" className="p-2 border border-gray-600 rounded-md w-full mb-4"/>
